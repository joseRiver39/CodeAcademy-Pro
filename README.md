...
3. Configura las variables de entorno: 
   ...
   - Agrega tu `GROQ_API_KEY` (puedes obtenerla gratis en [console.groq.com](https://console.groq.com/)).
...
Sin embargo, para el motor de ejecución de código (el Agente IA) no podemos hacer las peticiones a Groq desde el frontend, porque exponer nuestra `GROQ_API_KEY` al público sería un fallo de seguridad crítico.
...
4. La función llama a la IA (Groq), procesa la respuesta para que parezca una terminal real y se la devuelve a Angular.
